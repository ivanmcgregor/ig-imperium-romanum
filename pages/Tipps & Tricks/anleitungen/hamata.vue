<template>
  <div>
    <Intro small>
      <h2 class="mb-5">Die Lorica Hamata</h2>
      <b-row class="mb-4">
        <b-col offset-md="1" md="10">
          ...
          <p>
            ...
            besteht ein extremes Risiko von inneren Blutungen und
          ...
          <p>
            ...
            Methode verwendet. Der innere Ring war dabei ausgestanzt
            (vergleichbar mit einer Unterlegscheibe), die anderen Ringe wurden
            vernietet. Die gestanzten Ringe mussten nicht vernietet werden und
            dürften somit eine Zeitersparnis in der Herstellung bedeutet haben.
            Vielleicht gaben sie auch größeren Schutz, da der Ring nicht so
            leicht aufgesprengt werden konnte. Die kleinen Ringe könnten eine
            direkte Antwort auf die damals verwendeten Stichwaffefn wie dem
            Gladius sein.
          </p>
          <p>
            Ein Kettenhemd zu stricken ist sehr zeitaufwändig, bedarf aber
            weniger Werkzeug als für eine Segmentata notwendig sind.
          </p>
        </b-col>
      </b-row>
    </Intro>
