<template>
  <div>
    <Intro small>
      <h2 class="mb-5">Die Feminalia</h2>
      <b-row class="mb-4">
    ...
    <Section title="Anfertigen von Feminalia">
      <h3 class="h4 mt-4">1. Variante</h3>
      <b-img
        alt="Nicos Anleitung für Feminalia"
        :src="require('assets/anleitungen/nicos_feminalia.jpg')"
        fluid
      />
