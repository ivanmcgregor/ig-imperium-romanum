  ...
  <>
    ...
    >
      ...
      <div className="row mb-4">
        <div className="col-md-10 offset-md-1">
          <p>
            Die vermutlich römischste und deshalb auch bei Darstellern beliebte
            Rüstung ist die Segmentrüstung. Diese Rüstung der schweren
    ...
    <Section title="Kauf einer Segmentata">
      <p>
        ...
        Ungewissheit, sodass man sicherlich auch nicht vollends eingeschränkt
        ist. Vor dem Kauf sollte man idealerweise die unterschiedlichen Typen
        und verfügbaren Größen anprobieren, da sie unterschiedliche Passformen
        haben. Das entfällt bei maßgeschneiderten Rüstungen natürlich, doch
        diese sind erwartbar deutlich teurer.
      </p>
      <p>
        ...
        nachlässt. Einige Riemen und Stifte muss man von Werk aus direkt
        austauschen, um eine tragbare Rüstung daraus zu machen. Auch sind die
        Platten oftmals nicht so gebogen, dass man eine Rüstung direkt tragen
        kann oder will. Spätestens nach einigen Jahren des Tragens müssen
        sicherlich die meisten Lederriemen ausgetauscht werden, da sie sich
        geweitet haben oder spröde geworden sind.
      </p>
      <p>
