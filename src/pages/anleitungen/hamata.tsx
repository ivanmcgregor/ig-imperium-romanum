...
const hamata = () => (
  <>
    <Head>
      ...
      <link
        rel="canonical"
        href="https://www.ig-romanum.de/anleitungen/hamata"
      />
    </Head>
      ...
      <div className="row mb-4">
        <div className="col-md-10 offset-md-1">
          ...
          <p>
            ...
            Außerdem gaben sie auch größeren Schutz, da der Ring nicht so leicht
            aufgesprengt werden konnte. Die kleinen Ringe könnten eine direkte
            Antwort auf die damals verwendeten Stichwaffefn wie dem Gladius
            sein.
          </p>
          <p>
